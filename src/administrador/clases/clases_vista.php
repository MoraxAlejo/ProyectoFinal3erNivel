...
$consultaclases = $mysqli->query("SELECT * FROM cursos");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="bg-white shadow-sm shadow-gray-400 w-[100%] rounded-sm flex flex-col justify-center">
                    ...
                    <div class="flex flex-col gap-4 px-6 py-2">
                        <table class="w-full">
                            ...
                            <tbody>
                                <?php
                                $consultaclases = $mysqli->query("SELECT cursos.*, maestros.nombre 
                                 FROM cursos
                                ...
                                while ($row = $consultaclases->fetch_assoc()) {
                                    ...
                                    echo "<td class='px-2 py-2 border-[1px] border-gray-200'>" . $row['duracion'] . "</td>";
                                    echo "<td class='px-2 py-2 border-[1px] border-gray-200 flex justify-center'>
         <a href='./editar_clase.php?id=" . $row['id'] . "'><span class='material-symbols-outlined text-blue-400'>edit_square</span></a>
         <a href='#?id=" . $row['id'] . "'><span class='material-symbols-outlined text-red-400'>delete</span></a>
         </td>";
                                    echo "</tr>";
                                }
