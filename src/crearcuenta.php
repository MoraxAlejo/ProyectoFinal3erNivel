...
<body>
    <main class="h-[100vh] flex flex-col items-center bg-[#fff5d2]">
        ...
        <form class="bg-[white] flex flex-col items-center gap-5 pb-5 shadow-custom rounded-sm p-3" action="../actions/create.php" method="post">
            ...
            <div class="flex justify-end w-[100%]">
                <button type="submit" class=" bg-blue-500 text-white px-4 py-[6px] rounded-md right-5">Crear Cuenta</button>
            </div>
            <h1 class=" text-gray-500">O ingresa con tu cuenta: <a class="text-blue-500" href="index.php">Login</a></h1>
        </form>
    </main>
</body>
</html>